                ...
                <form action='submit'>
                  ...
                  <div className="buttonLinkContainer">
                    <div className="userInput">
                      ...
                      <input type='text' placeholder="enter what you desire here" onChange={this.handleChange} />
                    </div>
                    <div className="wishButton">
                      <Link to='/maze'>
                        <button className="landingPageButton"
                          onClick={() => this.props.handleSubmit(this.state.userWish)} >
                          <i aria-hidden="true" title="Down arrow icon let's user know to go down or more to see" className="fas fa-grip-lines">enter</i>
                        </button>
                      </Link>
                    </div>
                  </div>
